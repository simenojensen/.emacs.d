...
Gnupg keyring update

[[https://metaredux.com/posts/2019/12/09/dealing-with-expired-elpa-gpg-keys.html][More Information]]
...
* SQL
[[https://github.com/emacs-lsp/lsp-mssql][More Information]]
...
** =captain=
[[https://elpa.gnu.org/packages/captain.html][More Information]]
#+begin_src emacs-lisp
  (use-package captain
    :hook
    ((text-mode . (lambda ()
